...
create table test_one(pk INT NOT NULL, sk INT NOT NULL, vindex INT NOT NULL, sec_index INT NOT NULL, non_index INT NOT NULL, increment INT NOT NULL, nullable INT NULL, def_col INT NOT NULL DEFAULT 0, vindex_unique INT NOT NULL, sec_index_unique INT NOT NULL UNIQUE, PRIMARY KEY(pk));
create table test_two(pk INT NOT NULL, sk INT NOT NULL, vindex INT NOT NULL, sec_index INT NOT NULL, non_index INT NOT NULL, increment INT NOT NULL, nullable INT NULL, def_col INT NOT NULL DEFAULT 0, vindex_unique INT NOT NULL, sec_index_unique INT NOT NULL UNIQUE, PRIMARY KEY(pk));
